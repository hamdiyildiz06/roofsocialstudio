...
class Slides extends HY_Controller
{
    ...
    public function save(){
        ...
        if($validate){
            ...
            // Upload Süreci...
            $file_name = convertToSEO(pathinfo($_FILES["img_url"]["name"], PATHINFO_FILENAME)) . "-" . rand(10000,99999) . "." . pathinfo($_FILES["img_url"]["name"], PATHINFO_EXTENSION);

            $image_1024x650 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1024,650, $file_name);
            $image_1920x300 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1920,300, $file_name);
            $image_1920x650 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1920,650, $file_name);
            $image_1920x820 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",1920,820, $file_name);



            if($image_1920x300 && $image_1920x650 && $image_1024x650 && $image_1920x820){
    ...
    public function update($id){
        ...
        if($validate){
            ...
            if($_FILES["img_url"]["name"] !== "") {
                ...
                if($image_1024x650 && $image_1920x300  && $image_1920x650 && $image_1920x820){

                    delete_picture("slide_model", $id, "1024x650");
                    delete_picture("slide_model", $id, "1920x300");
                    delete_picture("slide_model", $id, "1920x650");
                    delete_picture("slide_model", $id, "1920x820");
