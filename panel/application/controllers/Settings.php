...
class Settings extends HY_Controller
{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $file_name = convertToSEO($this->input->post("company_name")) . "-" . rand(10000,99999) . "." . pathinfo($_FILES["logo"]["name"], PATHINFO_EXTENSION);
    ...
    public function update($id){
        ...
        if($validate){
            ...
            if($_FILES["mobile_logo"]["name"] !== "") {
                ...
                $file_name = convertToSEO($this->input->post("company_name")) . "-" . rand(10000,99999) . "." . pathinfo($_FILES["mobile_logo"]["name"], PATHINFO_EXTENSION);
            ...
            if($_FILES["favicon"]["name"] !== "") {
                ...
                $file_name = convertToSEO($this->input->post("company_name")) . "-" . rand(10000,99999) . "." . pathinfo($_FILES["favicon"]["name"], PATHINFO_EXTENSION);
