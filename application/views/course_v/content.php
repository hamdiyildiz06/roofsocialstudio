<div class="banner dark-translucent-bg" style="background-image:url('<?php echo base_url("panel/uploads/courses_v/1140x705/$course->img_url");?>'); background-position: 50% 21%;">
    <div class="container">
        <div class="row">
